...
var SC_MenuCascade = function(element) {
  var defaultParams = {
    "src": "",
    "cascadeData":
    [
  ...
  var app = this;
  var promise = ServercideApp.call(this, app, element, "SC_MenuCascade", defaultParams).then(function(){ app.postStrap(app); });
  return promise;
}
SC_MenuCascade.prototype = Object.create(ServercideApp.prototype);

SC_MenuCascade.prototype.onStrap = function(app){
...
SC_MenuCascade.prototype.postStrap = function(app){
  app.debugMsg(app.element.attr("id") + " app " + app.getMetaParam("type") + " is strapping, running onStrap before recursion.", 2);
  return new Promise(function(fulfill, reject){
    fulfill();
  });
...
SC_MenuCascade.prototype.discoveryComplete = function(app){
...
SC_MenuCascade.prototype.renderMenu = function(app, cascadeData, item, depth) {
  var html = "";
  var level_style = ""
