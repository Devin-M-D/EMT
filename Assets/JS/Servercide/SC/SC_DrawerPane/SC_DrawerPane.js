...
class SC_DrawerPane {
  constructor(element) {
    ...
    var promise = new ServercideApp(this, element, "SC_DrawerPane", defaultParams);
    return promise;
  }
  ...
  changeContent = function (app, tabName) {
    if (tabName == "side_nav") {
