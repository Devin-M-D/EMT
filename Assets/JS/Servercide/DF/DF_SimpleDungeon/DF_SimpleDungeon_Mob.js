...
var DF_SimpleDungeon_Mob = function(element) {
  ...
  var app = this;
  var promise = ServercideApp.call(this, app, element, "DF_SimpleDungeon_Mob", defaultParams).then(function(){ app.postStrap(app); });
  return promise;
}
...
DF_SimpleDungeon_Mob.prototype.postStrap = function(app){
  app.debugMsg(app.element.attr("id") + " app " + app.getMetaParam("type") + " is strapping, running onStrap before recursion.", [2, 3, 6, 7]);
  return new Promise(function(fulfill, reject){
    fulfill();
  });
